...
@interface PageUpValuesObject : KrollCoverageObject {
#else
@interface PageUpValuesObject : KrollObject {
#endif
@private
...
extern NSString * PageUpValues$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PageUpValuesObject *_pageupvalues;
    KrollObject* console;
	BOOL shutdown;
