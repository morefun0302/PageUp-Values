...
//@interface PageUpValuesObject : NSObject
//@end

@interface PageUpValuesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PageUpValuesObject class]])
		{
			for (NSString *key in [[(PageUpValuesObject*)o modules] allKeys])
			{
