...
/**
 Base class for all PageUpValues views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PageUpValues view hierarchy (such as wrapped iOS UIViews) was touched.
