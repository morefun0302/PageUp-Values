...
// in simulator we redefine to format for PageUpValues Developer console
...
{\
	NSString * exceptionName = [@"org.pageupvalues." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pageupvalues";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPageUpValuesNativeItemNone = -1, 
	UIPageUpValuesNativeItemSpinner = -2,
	UIPageUpValuesNativeItemProgressBar = -3,
	
	UIPageUpValuesNativeItemSlider = -4,
	UIPageUpValuesNativeItemSwitch = -5,
	UIPageUpValuesNativeItemMultiButton = -6,
	UIPageUpValuesNativeItemSegmented = -7,
	
	UIPageUpValuesNativeItemTextView = -8,
	UIPageUpValuesNativeItemTextField = -9,
	UIPageUpValuesNativeItemSearchBar = -10,
	
	UIPageUpValuesNativeItemPicker = -11,
	UIPageUpValuesNativeItemDatePicker = -12,
	
	UIPageUpValuesNativeItemInfoLight = -13,
	UIPageUpValuesNativeItemInfoDark = -14,
	
	UIPageUpValuesNativeItemDisclosure = -15,
	
	UIPageUpValuesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PageUpValues instances of
